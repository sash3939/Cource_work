...
- Веб интерфейс с логами моего nginx-сервера в [Kibana](http://158.160.96.134/:5601/app/discover#/?_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-15m,to:now))&_a=(columns:!(),filters:!(),index:'201838b0-2c0d-11ef-bf98-1da07a73652b',interval:auto,query:(language:kuery,query:''),sort:!(!('@timestamp',desc))))
